...
public final class Block {
    ...
    public static final byte TALL_GRASS = 11;
    public static final byte POPPY = 12;
    public static final byte DANDELION = 13;
    public static final byte BIRCH_LOG = 14;
    public static final byte BIRCH_LEAVES = 15;
    ...
    public static String getColor(byte type) {
        return switch (type) {
            ...
            case BEDROCK -> "#222222";
            case OAK_LOG -> "#674a27";
            case OAK_LEAVES -> "#498834";
            case DIAMOND_ORE -> "#55ffff";
            case WATER -> "#2b64d9";
            case TALL_GRASS -> "#59a42d";
            case POPPY -> "#dd2222";
            case DANDELION -> "#ffdd00";
            case BIRCH_LOG -> "#eaeaea";
            case BIRCH_LEAVES -> "#5a9e32";
            default -> "#888888";
        };
    }

    public static boolean isSolid(byte type) {
        return type != AIR && type != WATER && type < TALL_GRASS;
    }
}
